...
services = ["Брекет системы", "Имплантация", "Лечение кариеса", "Профессиональная гигиена", "Керамические виниры e-max", "Реставрация скола зуба", "Циркониевая коронка", "Удаление зуба"]
